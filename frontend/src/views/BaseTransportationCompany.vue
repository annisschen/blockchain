    ...
    <div class="head_back">
      ...
      >
        ...
        <el-submenu index="3">
          ...
          <el-menu-item index="3-1">确认 运输合同</el-menu-item>
          <el-menu-item index="3-2">发起 收货合同</el-menu-item>
          <el-menu-item index="3-3">查询 运输合同</el-menu-item>
        </el-submenu>
        <el-submenu index="4">
...
import ConfirmWaybill from '@/components/Transportation/ConfirmWaybill';
import LaunchDelivery from '@/components/Transportation/LaunchDelivery';
  ...
  methods: {
    handleSelect(key, keyPath) {
      switch (key) {
        ...
        case '3-1':
          this.currentTabComponent = 'ConfirmWaybill';
          break
        case '3-2':
          this.currentTabComponent = 'LaunchDelivery';
          break
        case '3-3':
